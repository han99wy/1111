<template>
    <div>
        ...
        <el-pagination v-model:page-size="pageSize" :small=false background="background" layout="prev, pager, next"
            :total="7" :page-count="6" :page-size="[5, 10, 15, 20]" @current-change="handlePageChange" class="page-pos" />
    </div>
</template>
...
import {getequment,createEquirment} from "../api/manage"
