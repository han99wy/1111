  ...
  <div>
    ...
    <el-dialog v-model="dialogVisible" title="提示" width="500">
      <el-form :model="form" :rules="rules" ref="formRef" label-width="90px">
        ...
        <el-form-item>
          <el-input v-model="form.amount" prop="amount" placeholder="最终价格"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="form.uid" prop="uid" placeholder="用户名字"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
...
import { getOrder, createOrder,deleteOrders } from '../api/manage';
